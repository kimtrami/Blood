...
public class HistoryBloodPressureAdapter extends RecyclerView.Adapter<HistoryBloodPressureAdapter.ViewHolder> {

    private List<BloodSugarEntity> data = new ArrayList<>();

    public void setData(List<BloodSugarEntity> data) {
        this.data.clear();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(BloodSugarEntity entity) {
            ...
            binding.txtTitle.setText("Blood Sugar");
        }
    }
